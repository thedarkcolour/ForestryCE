...
public class LepidopterologyItems {
	...
	public static final FeatureItem<ItemButterflyGE> SERUM = REGISTRY.item(() -> new ItemButterflyGE(ButterflyLifeStage.SERUM), "serum");
	public static final FeatureItem<ItemButterflyGE> CATERPILLAR = REGISTRY.item(() -> new ItemButterflyGE(ButterflyLifeStage.CATERPILLAR), "caterpillar");
