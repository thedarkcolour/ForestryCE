...
public class RainmakerRecipeCategory extends ForestryRecipeCategory<RainmakerFuel> {
	...
	@Override
	public RecipeType<RainmakerFuel> getRecipeType() {
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, RainmakerFuel recipe, IFocusGroup focuses) {
	...
	@Override
	public void draw(RainmakerFuel recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
	...
	private static Component getEffectString(RainmakerFuel recipe) {
		if (recipe.reverse()) {
