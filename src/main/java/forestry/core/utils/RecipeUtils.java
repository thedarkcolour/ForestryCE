...
public class RecipeUtils {
	...
	@Nullable
	public static IRainSubstrate getRainSubstrate(RecipeManager manager, ItemStack stack) {
		return getMatchingRecipe(manager, FactoryRecipeTypes.RAIN_SUBSTRATE, recipe -> recipe.matches(stack));
	}
