...
public class RecipeUtils {
	...
	@Nullable
	public static IFermenterFuel getFermenterFuel(RecipeManager manager, ItemStack stack) {
		return getMatchingRecipe(manager, FactoryRecipeTypes.FERMENTER_FUEL, recipe -> recipe.matches(stack));
	}
