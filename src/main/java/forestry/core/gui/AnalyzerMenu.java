...
public class AnalyzerMenu extends LiquidTanksMenu<TileAnalyzer> {
	public static AnalyzerMenu fromNetwork(int windowId, Inventory playerInv, FriendlyByteBuf extraData) {
	...
	public AnalyzerMenu(int windowId, Inventory player, TileAnalyzer tile) {
