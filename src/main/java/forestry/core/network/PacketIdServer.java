...
public class PacketIdServer {
	// Core Gui
	public static final CustomPacketPayload.Type<?> GUI_SELECTION_REQUEST = type("gui_selection_request");
	public static final CustomPacketPayload.Type<?> PIPETTE_CLICK = type("pipette_click");
	public static final CustomPacketPayload.Type<?> CHIPSET_CLICK = type("chipset_click");
	public static final CustomPacketPayload.Type<?> SOLDERING_IRON_CLICK = type("soldering_iron_click");
	// Sorting
	public static final CustomPacketPayload.Type<?> FILTER_CHANGE_RULE = type("filter_change_rule");
	...
	// Mail
	public static final CustomPacketPayload.Type<?> LETTER_INFO_REQUEST = type("letter_info_request");
	public static final CustomPacketPayload.Type<?> TRADING_ADDRESS_REQUEST = type("trading_address_request");
	public static final CustomPacketPayload.Type<?> LETTER_TEXT_SET = type("letter_text_set");
