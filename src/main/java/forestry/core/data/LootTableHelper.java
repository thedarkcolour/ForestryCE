...
public class LootTableHelper {
	...
	private LootPoolSingletonContainer.Builder<?> saplingLoot(ResourceLocation species) {
		return LootItem.lootTableItem(saplingItem(TreeLifeStage.SAPLING))
	...
	public record Entry(ResourceKey<LootTable> defaultLocation, String extension, LootTable.Builder builder) {
		public ResourceKey<LootTable> getLocation() {
			return ResourceKey.create(Registries.LOOT_TABLE, ForestryConstants.forestry(this.defaultLocation.location().getPath() + "/" + this.extension));
		}
	}
}
