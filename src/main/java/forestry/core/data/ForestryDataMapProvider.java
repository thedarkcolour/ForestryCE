...
public class ForestryDataMapProvider extends DataMapProvider {
	...
	private void gatherFermenterFuels() {
		...
		fuels.add(CoreItems.FERTILIZER_COMPOUND.item().builtInRegistryHolder(), new FermenterFuel(Preference.FERMENTED_CYCLE_FERTILIZER, Preference.FERMENTATION_DURATION_FERTILIZER), false);
		fuels.add(CoreItems.COMPOST.item().builtInRegistryHolder(), new FermenterFuel(Preference.FERMENTED_CYCLE_COMPOST, Preference.FERMENTATION_DURATION_COMPOST), false);
		fuels.add(CoreItems.MULCH.item().builtInRegistryHolder(), new FermenterFuel(Preference.FERMENTED_CYCLE_COMPOST, Preference.FERMENTATION_DURATION_COMPOST), false);
	}
	...
	private void gatherRainmakerFuels() {
		Builder<RainmakerFuel, Item> fuels = builder(ForestryDataMaps.RAINMAKER_FUELS);

		fuels.add(CoreItems.IODINE_CHARGE.item().builtInRegistryHolder(), new RainmakerFuel(10000, 0.01f, false), false);
		fuels.add(CoreItems.DISSIPATION_CHARGE.item().builtInRegistryHolder(), new RainmakerFuel(0, 0.075f, true), false);
	}
