...
public class LegacyFarmInventory extends InventoryPlantation<TilePlanter> implements IFarmInventoryInternal {
	...
	public LegacyFarmInventory(TilePlanter housing) {
