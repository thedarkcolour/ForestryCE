...
public class AlvearySieveMenu extends TileMenu<TileAlvearySieve> {
	public static AlvearySieveMenu fromNetwork(int windowId, Inventory inv, FriendlyByteBuf data) {
		...
		return new AlvearySieveMenu(windowId, inv, tile);    //TODO nullability.
	}

	public AlvearySieveMenu(int windowId, Inventory player, TileAlvearySieve tile) {
