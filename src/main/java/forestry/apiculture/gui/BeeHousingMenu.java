...
public class BeeHousingMenu extends TileMenu<TileBeeHousingBase> implements IContainerBeeHousing {
	...
	public BeeHousingMenu(int windowId, Inventory playerInv, TileBeeHousingBase tile, boolean hasFrames, GuiBeeHousing.Icon icon) {
